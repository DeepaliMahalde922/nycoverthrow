...
if ( !class_exists( 'MP_Admin_Notifications' ) )
{
        ...
        function __construct()
        {
            ...
            echo '<div class="wrap">';
                ...
                echo '<nav class="nav-tab-wrapper">';
                    ...
                    echo '<h1 class="">'.__('Notifications', 'marketplace').'</h1>';
                    ...
                    foreach ( $mp_tabs as $name => $label ) {
                        ...
                        echo '<a href="' . admin_url( 'admin.php?page=mp-notification&tab=' . $name ) . '" class="nav-tab ' . ( $current_tab == $name ? 'nav-tab-active' : '' ) . '">' . $label . '</a>';
	...
	<?php
        ...
        function mp_notification_products()
				{
						global $wpdb;
        ...
        public function mp_output_sections()
        {
            ...
            foreach ( $sections as $id => $label ) {
              echo '<li><a href="' . admin_url( 'admin.php?page=mp-notification&tab=' . $this->id . '&section=' . sanitize_title( $id ) ) . '" class="' . ( $current_section == $id ? 'current' : '' ) . '">' . $label . '</a> ' . ( end( $array_keys ) == $id ? '' : '|' ) . ' </li>';
            }
