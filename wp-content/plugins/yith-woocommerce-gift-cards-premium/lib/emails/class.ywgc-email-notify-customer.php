...
if ( ! class_exists ( "YWGC_Email_Notify_Customer" ) ) {
    /**
     ...
     * @extends \WC_Email
     */
    class YWGC_Email_Notify_Customer extends WC_Email {
        /**
        ...
        public function __construct () {
            ...
            $this->description = __ ( 'Notification for the customer that the purchased coupon has been used by the related person', 'yith-woocommerce-gift-cards' );
         ...
         *
         * @param YWGC_Gift_Card_Premium|YWGC_Gift_Card $gift_card the gift card to be sent
         *
         * @return bool|void
         */
        public function trigger ( $gift_card ) {
            ...
            if ( is_numeric ( $gift_card ) ) {
                $gift_card = new YWGC_Gift_Card_Premium( $gift_card );
            }
    ...
    } // end \YWGC_Email_Notify_Customer class
}

return new YWGC_Email_Notify_Customer();