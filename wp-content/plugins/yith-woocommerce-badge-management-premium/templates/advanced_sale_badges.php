...
if ( 'preview' === $product_id ) {
    ...
    if ( $product->product_type == 'variable' ) {
        ...
        foreach ( $children as $child_id ) {
            ...
            $sale_percentage_array[] = $price > 0 && $regular > 0 ? ( 100 - intval( $price / $regular * 100 ) ) : 0;
        }
        ...
        if ( $regular_price != 0 ) {
            $sale_percentage = 100 - intval( $price / $regular_price * 100 );
        } else {
            $sale_percentage = 0;
        }
    ...
    $saved_money = $product->get_display_price( $saved_money );
}
