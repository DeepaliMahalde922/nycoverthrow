...
<script type="text/javascript">
function ajaxSubmitCommentForm(){"use strict";var e={success:function(){$j("#commentform textarea").val(""),$j("#commentform .success p").text("Comment has been sent!")}};$j("#commentform").submit(function(){return $j(this).find('input[type="submit"]').next(".success").remove(),$j(this).find('input[type="submit"]').after('<div class="success"><p></p></div>'),$j(this).ajaxSubmit(e),!1})}function initialize(){"use strict";var e=[{stylers:[{hue:"#413427"},{saturation:-60},{lightness:-20},{gamma:1.51}]}],o=new google.maps.StyledMapType(e,{name:"Qode Map"});geocoder=new google.maps.Geocoder;var t=new google.maps.LatLng(-34.397,150.644),a={zoom:12,scrollwheel:!1,center:t,zoomControl:!0,zoomControlOptions:{style:google.maps.ZoomControlStyle.SMALL,position:google.maps.ControlPosition.RIGHT_CENTER},scaleControl:!1,scaleControlOptions:{position:google.maps.ControlPosition.LEFT_CENTER},streetViewControl:!1,streetViewControlOptions:{position:google.maps.ControlPosition.LEFT_CENTER},panControl:!1,panControlOptions:{position:google.maps.ControlPosition.LEFT_CENTER},mapTypeControl:!1,mapTypeControlOptions:{mapTypeIds:[google.maps.MapTypeId.ROADMAP,"qode_style"],style:google.maps.MapTypeControlStyle.HORIZONTAL_BAR,position:google.maps.ControlPosition.LEFT_CENTER},mapTypeId:"qode_style"};map=new google.maps.Map(document.getElementById("map_canvas"),a),map.mapTypes.set("qode_style",o)}function codeAddress(e){"use strict";if(""!==e){var o='<div id="content"><div id="siteNotice"></div><div id="bodyContent"><p>'+e+"</p></div></div>",t=new google.maps.InfoWindow({content:o});geocoder.geocode({address:e},function(o,a){if(a===google.maps.GeocoderStatus.OK){map.setCenter(o[0].geometry.location);var s=new google.maps.Marker({map:map,position:o[0].geometry.location,icon:"http://demo.select-themes.com/hazel/wp-content/themes/hazel/img/pin.png",title:e.store_title});google.maps.event.addListener(s,"click",function(){t.open(map,s)})}})}}
function showContactMap(){	
	var  addr = "<?php if(isset($qode_options['google_maps_address'])) { echo $qode_options['google_maps_address']; } ?>";
	"use strict";
	$j("#map_canvas").length>0&&(initialize(),codeAddress(""),codeAddress(""),codeAddress(""),codeAddress(""),
	codeAddress(addr))}
