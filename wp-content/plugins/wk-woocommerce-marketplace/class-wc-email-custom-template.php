 ...
 * @extends     WC_Email
 */
class MP_CTEMAIL extends WC_Email {
	...
	public function __construct() {
		$this->id               = 'new_temp';
		$this->title            = __( 'Custom Template', 'woocommerce' );
		$this->description      = __( 'New temp emails are sent to chosen recipient(s) ', 'woocommerce' );
		$this->heading          = __( 'new temp register', 'woocommerce' );
		$this->subject          = __( '[{site_title}] New temp register ({register_number}) - {register_date}', 'woocommerce' );
		$this->template_html    = 'custom-template.php';
