...
$welcome=sprintf( __("Welcome to %s! ",'marketplace'), get_option('blogname')) . "\r\n\n";
$msg=sprintf( __('New user registration on %s:','marketplace'), get_option('blogname') ) . "\n\n\r\n\r\n\n\n";
$username=__('Username:-','marketplace').$data['user_login'];
$password=__('User Email:-','marketplace').$data['user_email'];
