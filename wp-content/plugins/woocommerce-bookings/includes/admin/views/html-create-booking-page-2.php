			...
			<tbody>
				...
				<tr valign="top">
					...
					<td>
						...
						<input type="hidden" id="product-<?php echo esc_attr( $bookable_product_id ); ?>" name="bookable_product_id" value="<?php echo esc_attr( $bookable_product_id ); ?>" class="product-type-booking" />
