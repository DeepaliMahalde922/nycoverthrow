...
class MP_ATAEMAIL extends WC_Email {
	...
	public function __construct() {
		$this->id               = 'new_Query';
		$this->title            = __( 'Ask To Admin', 'woocommerce' );
		$this->description      = __( 'Query emails are sent to chosen recipient(s) ', 'woocommerce' );
		$this->heading          = __( 'new Query', 'woocommerce' );
		$this->subject          = __( '[{site_title}] New Query ({Query_number}) - {Query_date}', 'woocommerce' );
