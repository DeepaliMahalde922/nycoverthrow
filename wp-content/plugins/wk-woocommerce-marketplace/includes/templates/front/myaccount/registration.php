...
<div class="show_if_seller" <?php echo $role_style; ?>>
    ...
    <div class="split-row form-row-wide">
        ...
        <p class="form-row form-group">
            <label for="first-name"><?php _e( 'First Name', 'marketplace' ); ?> <span class="required">*</span></label>
        ...
        <p class="form-row form-group">
            <label for="last-name"><?php _e( 'Last Name', 'marketplace' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="company-name"><?php _e( 'Shop Name', 'marketplace' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="seller-url" class="pull-left"><?php _e( 'Shop URL', 'marketplace' ); ?> <span class="required">*</span></label>
    ...
    <p class="form-row form-group form-row-wide">
        <label for="shop-phone"><?php _e( 'Phone Number', 'marketplace' ); ?><span class="required">*</span></label>
...
<p class="form-row form-group user-role">
	...
	<ul class="nav nav-selector" role="tablist" style="padding:0;">
		...
		<li class="active" data-target="0">
			...
			<label class="radio" style="padding:0;margin:0;">
		        ...
		        <?php _e( 'I am a customer', 'marketplace' ); ?>
		    </label>
	    ...
	    <li data-target="1">
	    	...
	    	<label class="radio" style="padding:0;margin:0;">
		        ...
		        <?php echo _e( 'I am a seller', 'marketplace' ); ?>
		    </label>
