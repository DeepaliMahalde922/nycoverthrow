...
$all_reader_text = sprintf( _n( '%s notification', '%s notifications', $total_count, 'marketplace' ), number_format_i18n( $total_count ) );
...
$order_reader_text = sprintf( _n( '%s notification', '%s notifications', $order_count[0]['total'], 'marketplace' ), number_format_i18n( $order_count[0]['total'] ) );
...
$product_reader_text = sprintf( _n( '%s notification', '%s notifications', $product_count[0]['total'], 'marketplace' ), number_format_i18n( $product_count[0]['total'] ) );
...
$seller_reader_text = sprintf( _n( '%s notification', '%s notifications', $seller_count[0]['total'], 'marketplace' ), number_format_i18n( $seller_count[0]['total'] ) );
...
$admin_bar->add_menu( array(
    ...
    'meta'  => array(
        'title' => __('Notification', 'marketplace'),
    ),
));
