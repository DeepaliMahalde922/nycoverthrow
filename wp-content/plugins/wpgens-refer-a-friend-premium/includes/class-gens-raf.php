...
class Gens_RAF {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_filter( 'woocommerce_product_tabs', $plugin_public, 'raf_tab' );
		// Create button to create missing referral ID's for every user.
		$this->loader->add_filter( 'woocommerce_debug_tools', $plugin_public, 'add_missing_referrals_button' );
		// Auto apply RAF Coupons on cart for referrals.
		$this->loader->add_action( 'woocommerce_before_cart', $plugin_public, 'apply_matched_coupons' );
	...
	private function define_shortcodes() {
		...
		$this->loader->wpcf7_add_shortcode( 'gens_raf', $plugin_public, 'wpcf7_gens_shortcode_handler' );
