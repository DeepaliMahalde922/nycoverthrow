...
class WC_Booking {
	...
	public function __construct( $booking_data = false ) {
		...
		// Transient Clearing
		add_action( 'delete_booking_transients', 'wc_booking_delete_booking_transients' );
		add_action( 'delete_booking_dr_transients', 'wc_booking_delete_booking_dr_transients' );
		add_action( 'save_post', array( $this, 'clear_transients_on_save_post' ) );
		add_action( 'woocommerce_order_status_changed', array( $this, 'clear_booking_transients' ) );
		add_action( 'woocommerce_pre_payment_complete', array( $this, 'clear_booking_transients' ) );
	}
	 ...
	 *
	 */
	public function clear_booking_transients() {
		do_action( 'delete_booking_transients' );
		do_action( 'delete_booking_dr_transients' );
		do_action( 'delete_booking_ress_transients' );
		do_action( 'delete_booking_res_transients' );
	}
	 ...
	 * @param int $post_id
	 */
	public function clear_transients_on_save_post( $post_id ) {
