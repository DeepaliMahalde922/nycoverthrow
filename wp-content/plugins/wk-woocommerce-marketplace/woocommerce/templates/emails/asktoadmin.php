 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/asktoadmin.php.
 *
...
$msg= __('Someone asked query for following account:','marketplace') . "\r\n\r\n";
		          ...
		          <tr>
		 			<td class="content-wrap" style="padding: 20px;">
						<table width="100%" cellpadding="0" cellspacing="0">
							...
							<tr>
							  <td class="content-block">
								  <h4 style="display:inline-block; margin:0px;">'.$reference.'</h4><br>
