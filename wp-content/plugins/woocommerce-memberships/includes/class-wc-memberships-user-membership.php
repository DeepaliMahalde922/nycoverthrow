...
class WC_Memberships_User_Membership {
	...
	public function get_cancel_membership_url() {
		...
		echo '<p class="ovr_membership_user_spec_id" style="display: none">' . $this->id . '</p>';
		echo '<p class="ovr_membership_name" style="display: none">' . $this->plan->name . '</p>';
		echo '<p class="ovr_membership_cancel_nonce" style="display: none">' . wp_create_nonce( 'delete-user-membership-with-subscription' ) . '</p>';
