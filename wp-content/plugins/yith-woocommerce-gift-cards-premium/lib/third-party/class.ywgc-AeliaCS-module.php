...
if ( ! class_exists ( 'YWGC_AeliaCS_Module' ) ) {
    ...
    class YWGC_AeliaCS_Module {
        ...
        public function __construct () {
             ...
             */
            add_filter ( 'yith_ywgc_set_gift_card_coupon_amount_before_deduct', array ( $this, 'convert_user_currency_amount_to_base_currency' ) );
            ...
            add_filter ( 'yith_ywgc_gift_card_template_amount', array ( $this, 'get_amount_in_gift_card_currency' ), 10, 2 );
        }
